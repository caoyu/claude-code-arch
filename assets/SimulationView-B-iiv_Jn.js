...
#123: Fix login bug
#122: Add dark mode`,highlight:`MCP 工具的结果与内置工具无缝集成`}]}],q=g(`file-edit`),J=g(0),Y=f(()=>m.find(e=>e.id===q.value)),X=f(()=>Y.value?.steps||[]),Z=f(()=>X.value[J.value]),Q=f(()=>(J.value+1)/X.value.length*100);function ae(e){q.value=e,J.value=0}function oe(){J.value<X.value.length-1&&J.value++}function se(){J.value>0&&J.value--}function $(e){J.value=e}return(o,f)=>(t(),a(`div`,v,[f[8]||=d(`<div class="page-header" data-v-30fe7601><h1 class="page-title" data-v-30fe7601>场景模拟</h1><p class="page-subtitle" data-v-30fe7601>交互式执行演练 - 理解 Claude Code 的执行路径</p></div><div class="card" data-v-30fe7601><div class="card-title" data-v-30fe7601><svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-30fe7601><circle cx="12" cy="12" r="10" data-v-30fe7601></circle><path d="M12 16v-4M12 8h.01" data-v-30fe7601></path></svg> 概述 </div><p class="overview-text" data-v-30fe7601> 通过模拟真实场景，直观理解 Claude Code 在不同请求下的执行流程。 选择一个预设场景，逐步查看每个执行步骤，了解涉及的组件、输入输出数据， 以及系统如何处理各种任务类型。 </p></div>`,2),r(`div`,ee,[f[0]||=d(`<div class="card-title" data-v-30fe7601><svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" data-v-30fe7601><rect x="3" y="3" width="7" height="7" data-v-30fe7601></rect><rect x="14" y="3" width="7" height="7" data-v-30fe7601></rect><rect x="14" y="14" width="7" height="7" data-v-30fe7601></rect><rect x="3" y="14" width="7" height="7" data-v-30fe7601></rect></svg> 选择场景 </div>`,1),r(`div`,te,[(t(),a(c,null,n(m,e=>r(`div`,{key:e.id,class:u([`scenario-card`,{active:q.value===e.id}]),onClick:t=>ae(e.id)},[r(`div`,{class:`scenario-icon`,style:p({background:e.gradient})},[(t(),a(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,innerHTML:e.icon},null,8,re))],4),r(`h4`,null,i(e.title),1),r(`p`,null,i(e.desc),1)],10,ne)),64))])]),q.value?(t(),a(`div`,y,[r(`div`,b,[f[1]||=r(`svg`,{class:`icon`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[r(`polygon`,{points:`5 3 19 12 5 21 5 3`})],-1),l(` 模拟执行: `+i(Y.value?.title),1)]),r(`div`,x,[r(`div`,S,[r(`div`,{class:`progress-fill`,style:p({width:Q.value+`%`})},null,4)]),r(`div`,C,[r(`span`,null,`步骤 `+i(J.value+1)+` / `+i(X.value.length),1),r(`span`,w,i(Math.round(Q.value))+`%`,1)])]),r(`div`,T,[r(`div`,E,[(t(!0),a(c,null,n(X.value,(e,n)=>(t(),a(`div`,{key:n,class:u([`step-item`,{active:J.value===n,completed:J.value>n,pending:J.value<n}]),onClick:e=>$(n)},[r(`div`,O,[J.value>n?(t(),a(`svg`,k,[...f[2]||=[r(`polyline`,{points:`20 6 9 17 4 12`},null,-1)]])):(t(),a(`span`,A,i(n+1),1))]),r(`div`,j,[r(`div`,M,i(e.title),1),r(`div`,N,i(e.component),1)])],10,D))),128))]),r(`div`,P,[s(_,{name:`slide`,mode:`out-in`},{default:e(()=>[(t(),a(`div`,{key:J.value,class:`detail-content`},[r(`div`,ie,[r(`h3`,null,i(Z.value?.title),1),r(`span`,F,i(Z.value?.component),1)]),r(`p`,I,i(Z.value?.description),1),r(`div`,L,[f[3]||=r(`div`,{class:`highlight-label`},[r(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[r(`polygon`,{points:`13 2 3 14 12 14 11 22 21 10 12 10 13 2`})]),l(` 关键要点 `)],-1),r(`p`,null,i(Z.value?.highlight),1)]),Z.value?.input?(t(),a(`div`,R,[f[4]||=r(`div`,{class:`data-label`},[r(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[r(`path`,{d:`M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4`}),r(`polyline`,{points:`17 8 12 3 7 8`}),r(`line`,{x1:`12`,y1:`3`,x2:`12`,y2:`15`})]),l(` 输入数据 `)],-1),r(`div`,z,[r(`pre`,null,i(Z.value?.input),1)])])):h(``,!0),Z.value?.output?(t(),a(`div`,B,[f[5]||=r(`div`,{class:`data-label`},[r(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[r(`path`,{d:`M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4`}),r(`polyline`,{points:`7 10 12 15 17 10`}),r(`line`,{x1:`12`,y1:`15`,x2:`12`,y2:`3`})]),l(` 输出数据 `)],-1),r(`div`,V,[r(`pre`,null,i(Z.value?.output),1)])])):h(``,!0)]))]),_:1})])]),r(`div`,H,[r(`button`,{class:`control-btn`,disabled:J.value===0,onClick:se},[...f[6]||=[r(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[r(`path`,{d:`M19 12H5M12 19l-7-7 7-7`})],-1),l(` 上一步 `,-1)]],8,U),r(`div`,W,[(t(!0),a(c,null,n(X.value,(e,n)=>(t(),a(`button`,{key:n,class:u([`indicator`,{active:J.value===n,completed:J.value>n}]),onClick:e=>$(n)},null,10,G))),128))]),r(`button`,{class:`control-btn primary`,disabled:J.value===X.value.length-1,onClick:oe},[...f[7]||=[l(` 下一步 `,-1),r(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`},[r(`path`,{d:`M5 12h14M12 5l7 7-7 7`})],-1)]],8,K)])])):h(``,!0)]))}}),[[`__scopeId`,`data-v-30fe7601`]]);export{q as default};